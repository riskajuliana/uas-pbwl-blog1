                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        @else
                            ...
                            <li>
                                <a class="nav-link" href="{{ url('/category') }}" style="color: white">Kategori</a>
                            </li>

                            <li>
                                <a class="nav-link" href="{{ url('/post') }}" style="color: white">Post</a>
                            </li>

                            <li>
                                <a class="nav-link" href="{{ url('/photo') }}" style="color: white">Photo</a>
                            </li>

                            <li>
                                <a class="nav-link" href="{{ url('/album') }}" style="color: white">Album</a>
                            </li>
                    </div>
